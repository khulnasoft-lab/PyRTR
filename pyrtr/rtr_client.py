...
class Connect(object):
	...
	rtr_host = 'rtr.rpki.khulnasoft.com'
	rtr_port = 8282
	fd = None
...
def pyrtr(host=None, port=None, serial=None, session_id=None, timeout=None, dump=False, debug=0):
	"""RTR client"""
...
def doit(args=None):
	...
	pyrtr(host=host, port=port, serial=serial, session_id=session_id, timeout=timeout, dump=dump, debug=debug)
	sys.exit(0)
